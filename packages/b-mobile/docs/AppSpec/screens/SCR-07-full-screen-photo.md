...
**Reached from:** the dedicated fullscreen button next to the reaction counts on
`SCR-06 Entry Detail` — matching the live Blipfoto site, tapping the photo itself on `SCR-06`
loads the previous/next entry instead of opening this screen.
